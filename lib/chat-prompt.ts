...
export function buildSystemPrompt(): string {
  ...
  return [
    ...
    `Forma de pago: en pago único (100% al aprobar la demo) se puede pagar online con Mercado Pago (tarjeta de crédito o débito) o por transferencia bancaria. La otra alternativa es 50% al inicio y 50% contra entrega, por transferencia. En la página /contratar se elige plan y forma de pago y se genera un contrato simple para revisar antes de pagar (es un borrador: si el cliente necesita otra alternativa de pago, se ajusta antes de firmar). El botón de Mercado Pago aparece en el contrato generado cuando eligió pago único. La mantención se paga como cargo mensual por transferencia.`,
